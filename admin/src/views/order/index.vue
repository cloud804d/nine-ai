...
import { PAY_PLATFORM_LIST, PAY_PLATFORM_MAP, PAY_STATUS_MAP, PAY_STATUS_OPTIONS } from '@/constants'
...
<template>
  <div>
    <page-main class="flex justify-between items-center">
    ...
    <page-main style="width: 100%;">
      <el-table v-loading="loading" border :data="tableData" style="width: 100%;" size="large" :tooltip-options="{}">
        ...
        <el-table-column prop="total" label="支付平台" width="90" align="center">
          <template #default="scope">
            {{ PAY_PLATFORM_MAP[scope.row.payPlatform] }}
          </template>
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作">
          <template #default="scope">
            <el-popconfirm title="确认删除此订单么、删除订单不可恢复?" width="400" icon-color="red" @confirm="handleDeleteOrder(scope.row)">
              <template #reference>
