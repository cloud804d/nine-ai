...
if (import.meta.env.PROD) {
  ...
  //   console.info('%c由%cNine Ai%c驱动', copyright_sub_style, copyright_main_style, copyright_sub_style, '\nhttps://ai.jiangly.com')
  // }
  // else {
  //   console.info('%cPowered by%cNine Ai', copyright_sub_style, copyright_main_style, '\nhttps://ai.jiangly.com')
  // }
}
